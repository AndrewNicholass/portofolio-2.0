...
const MagicBento = ({
  ...
  const cardItems = Array.isArray(cards) && cards.length ? cards : cardData;
        ...
        <BentoCardGrid gridRef={gridRef}>
          <div className="card-responsive grid gap-2">
            {cardItems.map((card, index) => {
              ...
              const cardLabel =
                card.label ||
                (Array.isArray(card.tools) ? card.tools[0] : "Project");
              const cardTitle =
                card.title || card.name || `Project ${index + 1}`;
              const cardDescription =
                card.description || card.summary || "No description available.";
                ...
                return (
                  ...
                  >
                    <div className="card__header flex justify-between gap-3 relative text-white">
                      <span className="card__label text-base">{cardLabel}</span>
                    </div>
